...
const SidebarMobileProfile = ({ onClose }: SidebarMobileProfileProps) => {
    ...
    return (
        <>
            ...
            <div
                ref={sidebarRef}
                className={`w-[60%] bg-white min-h-screen overflow-auto fixed top-0 right-0 z-[999] border-l border-l-gray-200 shadow-2xl pr-5 transition-all duration-500 modal-enter-menu`}
            >

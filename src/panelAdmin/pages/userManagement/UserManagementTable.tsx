						...
						<div className="flex items-center gap-9 mt-10">
							<div className="flex flex-col gap-6">
								...
								<div className="relative">
									<select className="appearance-none border border-gray-300 text-black font-extrabold p-2 rounded-xl lg:w-48 w-36 focus:ring-0 focus:outline-none">
										<option>کاربر</option>
										<option>ادمین</option>
									</select>

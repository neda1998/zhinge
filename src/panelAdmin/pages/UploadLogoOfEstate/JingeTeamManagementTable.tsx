...
import UseCreatTeamMutation from "../../../hooks/mutation/creatTeam/UseCreatTeamMutation";
import UseDeleteTeamMutation from "../../../hooks/mutation/creatTeam/UseDeleteTeamMutation";
import UseUpdateTeamMutation from "../../../hooks/mutation/creatTeam/UseUpdateTeamMutation";
...
const JingeTeamManagementTable = () => {
    ...
    const creatTeamMutation = UseCreatTeamMutation();
    ...
    const handleSubmit = async () => {
        ...
        creatTeamMutation.mutate(
            { name, job, email, phone } as any,
            {
                onSuccess: () => {
                    setName("");
                    setJob("");
